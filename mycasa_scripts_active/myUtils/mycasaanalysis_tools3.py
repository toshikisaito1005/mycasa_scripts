...
def rot0_13co(Trot, flux_hj, lj_upp = 1, hj_upp = 2, data = "Qrot_CDMS.txt"):
    """
    ...
    Qrot = partition_func(Trot, datacol = 1, data = data)
...
def rot1_13co(flux_lj, flux_hj, lj_upp = 1, hj_upp = 2, data = "Qrot_CDMS.txt"):
    """
    input flux density = K.km/s
    """
    Eu = {1: 5.28880, 2: 15.86618, 3: 31.73179, 4: 52.88517, \
