...
increment_mask = 4.0 # 3.0: beam (mask) = beam_size * increment_mask
thres_masking = -3 # 7.5: threshold s/n ratio for masking
thres_mom = -3 # 0.5: threshold s/n ratio for immoments
pbcut = 0.30 # 0.65: pirmary beam cut
#
dir_data = "/Users/saito/data/ngc3110/"
galnames = ["ngc3110"]
res_highest = [0.179]
chanss = ["3~58"]
rms_co32_highs = [0.00055]
