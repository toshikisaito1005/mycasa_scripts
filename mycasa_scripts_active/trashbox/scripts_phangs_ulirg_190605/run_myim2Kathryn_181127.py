...
increment_mask = 1.5 # 3.0: beam (mask) = beam_size * increment_mask
thres_masking = 8.0 # 2.5: threshold s/n ratio for masking
thres_mom = 1.0 # 1.0: threshold s/n ratio for immoments
pbcut = 0.5 # 0.65: pirmary beam cut
#
dir_data = "/Users/saito/data/phangs_others/mom2_Kathryn/"
galnames = ["ic5332", # non-detection
            "ngc0628",
            "ngc1672",
            "ngc2835",
            "ngc3627",
            ...
            "ngc4535",
            "ngc1087"]
res_highest = [0.629,0.978,1.704,0.744,1.342,1.50,1.496,8.46]
chanss = ["1~90", # all channels
          "65~115",
          "19~190",
          "30~120",
          "45~245",
...
if [int(i) for i in str(do_step).zfill(3)][1] == 1:
    ...
    chans = chanss[unit]
    rms_co21 = rms_co21_highs[unit] # myim**1
