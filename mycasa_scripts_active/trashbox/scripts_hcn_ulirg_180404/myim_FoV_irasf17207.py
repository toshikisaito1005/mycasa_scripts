...
###irasf17207
name_csv = dir_work + "irasf17207_fov.csv"
name_casafile = dir_work + "irasf17207_fov"
data = []
...
cs.setreferencevalue([qa.convert("260.841429deg","rad")["value"],qa.convert("-0.283600deg","rad")["value"]],type="direction")
