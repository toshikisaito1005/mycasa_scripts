...
output = "w_bm_vs_ap_r21_median.txt"
...
for i in range(len(txt_files)):
    ...
    data = np.loadtxt(txt_files[i], usecols=(8,9,12,13))
...
plt.text(1*scale + (35*scale-1*scale)*0.05,
         ...
         "(a) median $R_{21,w}$, $Me$($R_{21,w}$)")
cbar=plt.colorbar()
cbar.set_label("$Me$($R_{21,w}$)", size=18)
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/fw05a_bm_vs_ap_R21_median_n4321.png",
            dpi=100)
