...
plt.text(1*scale + (35*scale-1*scale)*0.05,
         ...
         "(a) median $R_{21,1/w}$, $Me$($R_{21,1/w}$)")
cbar=plt.colorbar()
cbar.set_label("$Me$($R_{21,1/w}$)", size=18)
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/fiw05a_bm_vs_ap_R21_median_n4321.png",
            dpi=100)
