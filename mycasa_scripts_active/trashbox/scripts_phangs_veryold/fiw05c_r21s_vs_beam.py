...
# plot 1
data = np.loadtxt(dir_data + "iw_bm_vs_ap_r21_median.txt")
...
plt.ylabel("$Me$($R_{21,1/w}$)")
plt.text(0 + (35*scale-0*scale)*0.05,
         0.65 - (0.65-0.35)*0.08,
         "(c) $Me$($R_{21,1/w}$) vs. Beam Size")
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/fiw05c_r21_median_vs_bm_n4321.png",
            dpi=100)
...
plt.ylim([0.35,0.65])
plt.xlabel("Beam Size (kpc)")
plt.ylabel("$Me$($M_{21,1/w}$)")
plt.text(0 + (35*scale-0)*0.05,
         0.65 - (0.65-0.35)*0.08,
         "(d) $Me$($M_{21,1/w}$) vs. Beam Size")
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/fiw05d_p21_median_vs_bm_n4321.png",
            dpi=100)
