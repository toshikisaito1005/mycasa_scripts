...
output = "bm_vs_ap_r21_iw_median.txt"
...
plt.text(1*scale + (35*scale-1*scale)*0.05,
         ...
         "(c) inverse-weighted-median $R$ ($\~R_{1/w}$)")
cbar=plt.colorbar()
cbar.set_label("$\~R_{1/w}$", size=18)
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/f06c_bm_vs_ap_R21_iw_median_n4321.png",
            dpi=100)
