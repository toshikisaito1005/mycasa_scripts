...
output = "bm_vs_ap_r21_w2_median.txt"
...
plt.text(1*scale + (35*scale-1*scale)*0.05,
         ...
         "(a) square-weighted-median $R$ ($\~R_{w^2}$)")
cbar=plt.colorbar()
cbar.set_label("$\~R_{w^2}$", size=18)
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/f06i_bm_vs_ap_R21_w2_median_n4321.png",
            dpi=100)
