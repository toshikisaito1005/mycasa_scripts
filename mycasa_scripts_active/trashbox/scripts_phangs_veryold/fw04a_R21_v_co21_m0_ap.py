...
def load_data(txt_data):
    ...
    data = np.loadtxt(txt_data, usecols=(8,9,12,13))
...
a00b.set_xlabel("log $I_{CO(2-1),w}$ (K km s$^{-1}$)")
a00.set_ylabel("$R_{21}$")
...
ay9.set_xlabel("log $I_{CO(2-1),w}$ (K km s$^{-1}$)")
...
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/figw04a_n4321_r21_v_co21_ap.png",
            dpi=100)
