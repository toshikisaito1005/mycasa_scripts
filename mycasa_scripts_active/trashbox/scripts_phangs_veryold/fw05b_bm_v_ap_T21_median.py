...
output = "w_bm_vs_ap_t21_median.txt"
...
plt.text(1*scale + (35*scale-1*scale)*0.05,
         ...
         "(b) median $M_{21,w}$, $Me$($M_{21,w}$)")
cbar=plt.colorbar()
cbar.set_label("$Me$($M_{21,w}$)", size=18)
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/fw05b_bm_vs_ap_P21_median_n4321.png",
            dpi=100)
