...
output = "bm_vs_ap_r21_w_median.txt"
...
plt.text(1*scale + (35*scale-1*scale)*0.05,
         ...
         "(a) weighted-median $R$ ($\~R_w$)")
cbar=plt.colorbar()
cbar.set_label("$\~R_w$", size=18)
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/f06a_bm_vs_ap_R21_w_median_n4321.png",
            dpi=100)
