...
a00b.set_xlabel("log $I_{CO(1-0),1/w}$ (K km s$^{-1}$)")
a00.set_ylabel("log $I_{CO(2-1),1/w}$ (K km s$^{-1}$)")
...
ax9b.set_ylabel("log $I_{CO(2-1),1/w}$ (K km s$^{-1}$)")
...
ay9.set_xlabel("log $I_{CO(1-0),1/w}$ (K km s$^{-1}$)")
...
a00.text(limit[0] + length*0.05, limit[1] - length*0.15,
         "a) $I_{CO(1-0),1/w}$ vs $I_{CO(2-1),1/w}$ with \n    varying beam size")
...
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/figiw03a_n4321_m0_bm.png",
            dpi=100)
