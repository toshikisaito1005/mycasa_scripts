...
output = "bm_vs_ap_t21_iw_median.txt"
...
plt.text(1*scale + (35*scale-1*scale)*0.05,
         ...
         "(d) inverse-weighted-median $M$ ($\~M_{1/w}$)")
cbar=plt.colorbar()
cbar.set_label("$\~M_{1/w}$", size=18)
plt.savefig("/Users/saito/data/phangs/co_ratio/eps/f06d_bm_vs_ap_P21_iw_median_n4321.png",
            dpi=100)
