...
dir_data2 = "../../ngc3110/ana/datacube_LTE_uv_smooth/"
...
product_file = dir_product + "ngc3110_flux_uvlim.txt"
...
for i in range(25):
    ...
    for j in range(25):
        ...
        #co10
        value = imval(imagename = dir_data2 + "line_12co10_contsub_clean20_nat_uv_smooth.image.moment0",
                      region = region_file)
        value_masked_co10 = value["data"] * value["mask"]
        #data_co10 = value_masked_co10.sum(axis = (0, 1)) / 59.5049
        data_co10 = value_masked_co10.sum(axis = (0, 1)) * 1.226 * 10 ** 6. / 1.813 ** 2 / 115.27120 ** 2 / 113
        #co21
        value = imval(imagename = dir_data2 + "line_12co21_contsub_clean20_nat_smooth.image.moment0",
                      region = region_file)
        value_masked_co21 = value["data"] * value["mask"]
        #data_co21 = value_masked_co21.sum(axis = (0, 1)) / 59.5049
        data_co21 = value_masked_co21.sum(axis = (0, 1)) * 1.226 * 10 ** 6. / 1.813 ** 2 / 230.53800 ** 2 / 113
        #13co10
        value = imval(imagename = dir_data2 + "line_13co10_contsub_clean20_nat_uv_smooth.image.moment0",
                      region = region_file)
        value_masked_13co10 = value["data"] * value["mask"]
        #data_13co10 = value_masked_13co10.sum(axis = (0, 1)) / 59.5049
        data_13co10 = value_masked_13co10.sum(axis = (0, 1)) * 1.226 * 10 ** 6. / 1.813 ** 2 / 110.20135430 ** 2 / 113
        #13co21
        value = imval(imagename = dir_data2 + "line_13co21_contsub_clean20_nat_smooth.image.moment0",
                      region = region_file)
        value_masked_13co21 = value["data"] * value["mask"]
        #data_13co21 = value_masked_13co21.sum(axis = (0, 1)) / 59.5049
        data_13co21 = value_masked_13co21.sum(axis = (0, 1)) * 1.226 * 10 ** 6. / 1.813 ** 2 / 220.39868420 ** 2 / 113
        # writing
        f = open(product_file, "a")
