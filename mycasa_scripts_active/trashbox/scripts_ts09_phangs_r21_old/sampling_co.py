...
do_steps = [0,1]
galnames = ["ngc4254"]
#beam_sizes = [4.0, 4.0, 8.0, 8.0, 8.0, 2.0] # do_steps = 0, 1, 2, 3
beam_sizes = [22.0] # do_steps = 0, 1, 2, 3
apertures = [[36]] # do_steps = 0, 1, 2
...
### Define
#####################
def do_step_0(dir_data, param, beam_sizes):
...
def do_step_1(dir_data, param, beam_sizes):
    chans = param[3]
...
def do_step_2(dir_data, param, beam_sizes, apertures):
    ...
    for j in range(len(weights)):
        r21.sampling_co(dir_data = dir_data,
                        galname = param[0],
                        chans = param[3],
                        suffix = str(beam_size).replace(".","p"),
                        apertures = apertures,
