...
os.system("rm -rf " + dir_output + "fig_radius_ratio_m74_0.png")
plt.savefig(dir_output + "fig_radius_ratio_m74_0.png", dpi=300)
...
os.system("rm -rf " + dir_output + "fig_co10_ratio_m74_0.png")
plt.savefig(dir_output + "fig_co10_ratio_m74_0.png", dpi=300)
...
os.system("rm -rf " + dir_output + "fig_co21_ratio_m74_0.png")
plt.savefig(dir_output + "fig_co21_ratio_m74_0.png", dpi=300)
...
os.system("rm -rf " + dir_output + "fig_radius_image_m74_0.png")
plt.savefig(dir_output + "fig_radius_image_m74_0.png", dpi=300)
...
os.system("rm -rf " + dir_output + "fig_hist_m74_0.png")
plt.savefig(dir_output + "fig_hist_m74_0.png", dpi=300)
