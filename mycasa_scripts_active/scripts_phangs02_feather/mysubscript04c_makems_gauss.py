...
#dir_data = "../"
projects = ["test07"] # ["test06"]
ptgtable = "test03" # "test02"
image_length = 280. # arcsec
...
#
direction_ra1 = str(float(direction_ra.strip("deg"))+60/3600.)+"deg"
...
cl.addcomponent(dir=direction,
                ...
                positionangle="45.0deg")
#
direction_ra3 = str(float(direction_ra.strip("deg"))-60/3600.)+"deg"
