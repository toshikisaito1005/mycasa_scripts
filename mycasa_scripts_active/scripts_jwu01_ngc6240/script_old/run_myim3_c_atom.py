...
thres_masking = 7.0 # 2.5: threshold s/n ratio for masking
thres_mom = 1.0 # 1.0: threshold s/n ratio for immoments
pbcut = 0.60 # 0.65: pirmary beam cut
#
dir_data = "/Users/saito/data/proj_jwu/"
galnames = ["ngc6240_ci10"]
res_highest = [0.70]
chanss = ["10~42"]
rms_co32_highs = [0.01]
restfreqs = [492.16065100]
