...
#for i in [0]:
	...
	if i==0:
		...
		label3=None
	#
	norm_disp = np.log10(np.array(statslist_r21)[:,0]-np.array(statslist_r21)[:,4]) / np.log10(np.array(statslist_r21)[:,0][0]-np.array(statslist_r21)[:,4][0])
	bars = ax.plot(list_beam, norm_disp, "o-", color=color, alpha=0.6, lw=2, label=label1)
	[bar.set_alpha(0.6) for bar in bars]
	#
	norm_disp = np.log10(np.array(statslist_r21_wco10)[:,0]-np.array(statslist_r21_wco10)[:,4]) / np.log10(np.array(statslist_r21_wco10)[:,0][0]-np.array(statslist_r21_wco10)[:,4][0])
	bars = ax.plot(list_beam, norm_disp, "o-", color=color, alpha=0.6, lw=2, label=label2)
	[bar.set_alpha(0.4) for bar in bars]
	#
	norm_disp = np.log10(np.array(statslist_r21_wco21)[:,0]-np.array(statslist_r21_wco21)[:,4]) / np.log10(np.array(statslist_r21_wco21)[:,0][0]-np.array(statslist_r21_wco21)[:,4][0])
