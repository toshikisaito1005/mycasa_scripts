...
ax1.set_ylim(ylim)
#
H, xedges, yedges = np.histogram2d(np.log10(co21_inmask_all[0]/co10_inmask_all[0]),np.log10(co21_inmask_all[0]),bins=15,range=([-1.2,0.5],[-0.0,2.1]))
extent = [yedges[0],yedges[-1],xedges[0],xedges[-1]]
ax1.contour(H/H.max()*100,levels=levels,extent=extent,colors=["red"],zorder=1,linewidths=1.5,alpha=1.0)
#
H, xedges, yedges = np.histogram2d(np.log10(co21_outmask_all[0]/co10_outmask_all[0]),np.log10(co21_outmask_all[0]),bins=15,range=([-1.2,0.5],[-0.0,2.1]))
extent = [yedges[0],yedges[-1],xedges[0],xedges[-1]]
...
ax2.set_ylim(ylim)
#
H, xedges, yedges = np.histogram2d(np.log10(co21_inmask_all[1]/co10_inmask_all[1]),np.log10(co21_inmask_all[1]),bins=15,range=([-1.0,0.7],[-0.0,3.2]))
extent = [yedges[0],yedges[-1],xedges[0],xedges[-1]]
ax2.contour(H/H.max()*100,levels=levels,extent=extent,colors=["red"],zorder=1,linewidths=1.5,alpha=1.0)
#
H, xedges, yedges = np.histogram2d(np.log10(co21_outmask_all[1]/co10_outmask_all[1]),np.log10(co21_outmask_all[1]),bins=15,range=([-1.0,0.7],[-0.0,3.2]))
extent = [yedges[0],yedges[-1],xedges[0],xedges[-1]]
ax2.contour(H/H.max()*100,levels=levels,extent=extent,colors=["blue"],zorder=1,linewidths=1.5,alpha=1.0)
...
ax3.set_ylim(ylim)
#
H, xedges, yedges = np.histogram2d(np.log10(co21_inmask_all[2]/co10_inmask_all[2]),np.log10(co21_inmask_all[2]),bins=15,range=([-1.2,0.7],[-0.0,3.0]))
extent = [yedges[0],yedges[-1],xedges[0],xedges[-1]]
ax3.contour(H/H.max()*100,levels=levels,extent=extent,colors=["red"],zorder=1,linewidths=1.5,alpha=1.0)
#
H, xedges, yedges = np.histogram2d(np.log10(co21_outmask_all[2]/co10_outmask_all[2]),np.log10(co21_outmask_all[2]),bins=15,range=([-1.2,0.7],[-0.0,3.0]))
extent = [yedges[0],yedges[-1],xedges[0],xedges[-1]]
ax3.contour(H/H.max()*100,levels=levels,extent=extent,colors=["blue"],zorder=1,linewidths=1.5,alpha=1.0)
