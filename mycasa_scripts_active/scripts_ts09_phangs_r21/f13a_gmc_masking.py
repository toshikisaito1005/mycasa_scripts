...
ax1.plot([p16_in_norm, p84_in_norm], [ylim[1]*0.95, ylim[1]*0.95], "-", c=cm.bwr(1/1.), lw=2, zorder=0)
#
...
ax1.plot(p50_out_norm, ylim[1]*0.88, "o", markeredgewidth=0, c=cm.bwr(0/1.), markersize=7, zorder=1)
ax1.plot([p16_out_norm, p84_out_norm], [ylim[1]*0.88, ylim[1]*0.88], "-", c=cm.bwr(0/1.), lw=2, zorder=0)
#
...
ax1.text(xlim[0]+(xlim[1]-xlim[0])*0.03, ylim[0]+(ylim[1]-ylim[0])*0.9, "NGC 0628 (Cloud Mask)")
...
ax2.text(xlim[0]+(xlim[1]-xlim[0])*0.03, ylim[0]+(ylim[1]-ylim[0])*0.9, "NGC 3627 (Cloud Mask)")
...
ax3.text(xlim[0]+(xlim[1]-xlim[0])*0.03, ylim[0]+(ylim[1]-ylim[0])*0.9, "NGC 4321 (Cloud Mask)")
