...
def get_best_co21_parameter(
	...
	if not done:
		for i, j, k in itertools.product(range_slope, range_intercept, range_scatter):
			...
			log_r21_mom0_k_model_scatter_noise = np.log10(10**log_co21_mom0_k_model_scatter_noise/10**log_co21_mom0_k_model_scatter_noise)
...
def create_best_models(
	...
	range_co10_input = [log_co10_mom0_k.min(), log_co10_mom0_k.max()]
	num_co10 = len(log_co10_mom0_k)
	print("# range_co10_input = " + str(range_co10_input))
	#
	### co21 parameters
	...
	range_co21_input = [log_co21_mom0_k.min(), log_co21_mom0_k.max()]
	num_co21 = len(log_co21_mom0_k)
	print("# range_co21_input = " + str(range_co21_input))
	#
	### log_co_mom0_k_model
...
for i in range(100):
	...
	best_co21_parameter = get_best_co21_parameter(dir_proj, log_co10_mom0_k_model_for_co21, log_co10_mom0_k_model_scatter_for_co21, log_co10_mom0_k, log_co21_mom0_k, log_co10_noise_k, log_co21_noise_k, xbins_co10, xbins_co21, nbins)
	#
	### output
