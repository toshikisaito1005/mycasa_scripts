...
#ax2
ax2.plot(best_lognorm_co10, best_lognorm_co21, "o", color="red", alpha=0.5, markersize=5, markeredgewidth=0, zorder=1e20)
ax2.plot(log_co10_mom0_k, log_co21_mom0_k, "o", color="black", alpha=0.5, markersize=2, markeredgewidth=0)
#
