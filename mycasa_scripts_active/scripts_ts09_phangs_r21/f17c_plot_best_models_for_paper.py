...
#
ax1.plot(co21_high, r21_high, "o", color="grey", alpha=1.0, markersize=15, markeredgewidth=0)
ax1.plot(co21_low, r21_low, "o", color="black", alpha=1.0, markersize=15, markeredgewidth=0)
ax1.set_xlim(xlim)
