...
range_scatters_co10 = [[np.log10(0.01), np.log10(1.5)],
					   ...
					   [np.log10(0.01), np.log10(1.5)]]
range_slopes_co21 = [[1.06,1.16], # [1.12,1.18], [1.12,1.18], [1.10,1.16], [1.10,1.16], [1.10,1.16]
...
range_scatters_co21 = [[np.log10(0.03),np.log10(0.30)], # [(1.30),(1.55)], [(0.70),(0.90)], [(0.50),(0.70)], [(0.03),(0.30)], [(0.03),(0.30)]
