...
range_scatters_co10 = [[np.log10(0.01), np.log10(1.5)],
					   ...
					   [np.log10(0.01), np.log10(1.5)]]
range_slopes_co21 = [[1.00,1.10], # [1.12,1.18], [1.12,1.18], [1.10,1.16], [1.10,1.16], [1.10,1.16]
					 [0.96,1.02], # [1.00,1.06], [1.00,1.06], [0.98,1.04], [0.96,1.02], [0.98,1.04]
...
range_scatters_co21 = [[np.log10(0.003),np.log10(0.01)], # [(1.30),(1.55)], [(0.70),(0.90)], [(0.50),(0.70)], [(0.03),(0.30)], [(0.03),(0.30)]
					   [np.log10(1.0),np.log10(2.0)], # [(2.5),(3.5)], [(1.5),(2.5)], [(1.2),(2.2)], [(1.0),(2.0)], [(1.0),(2.0)]
