...
range_slopes_co21 = [[1.12,1.18], # [1.12,1.18], [1.12,1.18], [1.12,1.18]
					 [0.98,1.10], # [0.98,1.10]
					 [1.00,1.10]] # [1.24,1.34], [1.10,1.15], [1.00,1.10]
range_intercepts_co21 = [[-0.60,-0.30], # [-0.60,-0.30], [-0.60,-0.30], [-0.60,-0.30]
						 [-0.40,0.10], # [-0.40,0.10]
						 [-0.50,-0.10]] # [-1.40,-0.40], [-1.00,0.00], [-0.70,0.20], -0.80--0.00
range_scatters_co21 = [[np.log10(0.10),np.log10(0.30)], # [(1.30),(1.55)], [(0.70),(0.90)], [(0.50),(0.70)], [(0.20),(0.40)], 0.0-0.2
					   ...
					   [np.log10(0.6),np.log10(0.9)]] # [(1.0),(1.8)], [(1.0),(1.5)], [(0.6),(1.1)], 0.5-1.3, 0.2-1.0
#
nbins = nbins[i]
beams = beams[i]
scale = scales[i]
