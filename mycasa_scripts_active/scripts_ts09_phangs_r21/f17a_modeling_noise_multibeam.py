...
freqco10 = 115.27120
freqco21 = 230.53800
nbins = [25] # 10, 10, 20, 30, 40 # 30, 20, 20, 10, 10 # 40, 30, 25, 20, 15
percentile = 84
beams = ["12p0"] # "20p0", "16p0", "12p0", "08p0"
...
def get_best_co21_parameter(
	...
	range_intercept = np.linspace(-0.80, -0.00, 11) # -0.45-020 (n0628), -0.40-0.10 (n3627), -1.00--0.50, -1.00--0.50, -0.80--0.00 (n4321)
