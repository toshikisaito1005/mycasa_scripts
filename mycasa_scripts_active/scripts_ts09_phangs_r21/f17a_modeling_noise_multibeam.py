...
range_scatters_co10 = [[np.log10(0.01), np.log10(1.5)],
					   ...
					   [np.log10(0.01), np.log10(1.5)]]
range_slopes_co21 = [[1.10,1.25], # [1.10,1.40], 1.05-1.40, 1.05-1.30, 1.05-1.30, 1.05-1.30
					 [], # 0.95-1.10
					 []] # 1.00-1.15
range_intercepts_co21 = [[-0.50,-0.20], # [-0.50,-0.20]
						 [], # -0.40-0.10
						 []] # -1.00--0.50, -1.00--0.50, -0.80--0.00, -0.80--0.00
range_scatters_co21 = [[np.log10(1.0),np.log10(1.8)], # [np.log10(1.0),np.log10(1.8)], 0.5-1.3, 0.5-1.0, 0.0-0.5, 0.0-0.2
