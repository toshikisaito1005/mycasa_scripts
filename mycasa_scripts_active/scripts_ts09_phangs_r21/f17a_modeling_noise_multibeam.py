...
range_scatters_co10 = [[np.log10(0.01), np.log10(1.5)],
					   ...
					   [np.log10(0.01), np.log10(1.5)]]
range_slopes_co21 = [[1.12,1.18], # [1.12,1.18], [1.12,1.18]
					 [0.98,1.10], # [0.98,1.10]
					 []] # 1.00-1.15
range_intercepts_co21 = [[-0.60,-0.30], # [-0.60,-0.30], [-0.60,-0.30]
						 [-0.40,0.10], # [-0.40,0.10]
						 []] # -1.00--0.50, -1.00--0.50, -0.80--0.00, -0.80--0.00
range_scatters_co21 = [[np.log10(1.00),np.log10(1.30)], # [np.log10(1.30),np.log10(1.55)], [np.log10(1.00),np.log10(1.30)], 0.5-1.0, 0.0-0.5, 0.0-0.2
					   [np.log10(2.5),np.log10(3.5)], # [np.log10(2.5),np.log10(3.5)], 2.5-3.5, 2.0-3.0, 1.5-2.5, 1.5-2.5
