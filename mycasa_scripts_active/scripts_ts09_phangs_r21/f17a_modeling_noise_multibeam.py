...
freqco10 = 115.27120
freqco21 = 230.53800
nbins = [40,30,40] # 10, 10, 20, 30, 40 # 30, 20, 20, 10, 10 # 40, 30, 25, 20, 15
percentile = 84
...
def get_best_co21_parameter(
	...
	#
	range_slope = np.linspace(1.05, 1.15, 16) # np.linspace(1.05, 1.15, 16) # np.linspace(0.95, 1.15, 16)
	range_intercept = np.linspace(-1.20, -0.50, 11) # np.linspace(-0.45, -0.20, 11) # np.linspace(-0.45, -0.00, 11)
