...
range_slopes_co21 = [[1.10,1.16], # [1.12,1.18], [1.12,1.18], [1.12,1.18], [1.10,1.16], [1.10,1.16]
					 ...
					 [0.96,1.02]] # [1.24,1.34], [1.10,1.15], [0.96,1.02]
range_intercepts_co21 = [[-0.60,-0.30], # [-0.60,-0.30], [-0.60,-0.30], [-0.60,-0.30], [-0.60,-0.30], [-0.60,-0.30]
						 ...
						 [-0.50,-0.10]] # [-1.40,-0.40], [-1.00,0.00], [-0.50,-0.10], -0.80--0.00
range_scatters_co21 = [[np.log10(0.005),np.log10(0.05)], # [(1.30),(1.55)], [(0.70),(0.90)], [(0.50),(0.70)], [(0.03),(0.30)], [(0.03),(0.30)]
					   [np.log10(1.0),np.log10(2.0)], # [(2.5),(3.5)], [(1.5),(2.5)], [(1.2),(2.2)], , [(1.0),(2.0)], 
					   [np.log10(1.0),np.log10(1.4)]] # [(1.0),(1.8)], [(1.0),(1.5)], [(0.8),(1.2)], 0.5-1.3, 0.2-1.0
#
nbins = nbins[i]
beams = beams[i]
scale = scales[i]
