...
range_scatters_co10 = [[np.log10(0.01), np.log10(1.5)],
					   ...
					   [np.log10(0.01), np.log10(1.5)]]
range_slopes_co21 = [[1.12,1.18], # [1.12,1.18], [1.12,1.18], [1.12,1.18]
					 [0.98,1.10], # [0.98,1.10]
					 [0.96,1.02]] # [1.24,1.34], [1.10,1.15], [0.96,1.02]
range_intercepts_co21 = [[-0.60,-0.30], # [-0.60,-0.30], [-0.60,-0.30], [-0.60,-0.30]
						 [-0.40,0.10], # [-0.40,0.10]
						 [-0.50,-0.10]] # [-1.40,-0.40], [-1.00,0.00], [-0.50,-0.10], -0.80--0.00
range_scatters_co21 = [[np.log10(0.002),np.log10(0.02)], # [(1.30),(1.55)], [(0.70),(0.90)], [(0.50),(0.70)], [(0.20),(0.40)], 0.0-0.2
