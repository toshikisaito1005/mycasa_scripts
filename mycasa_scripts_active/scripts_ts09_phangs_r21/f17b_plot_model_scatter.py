...
ax1.plot(n0628_xaxis_co10, n0628_std_scatter_cut, "--", color=cm.brg(0/2.5), alpha=0.5, lw=4, label="NGC 0628 (sensitivity-cut)")
ax1.plot(n3627_xaxis_co10, n3627_std_scatter_cut, "--", color=cm.brg(1/2.5), alpha=0.5, lw=4, label="NGC 3627 (sensitivity-cut)")
ax1.plot(n4321_xaxis_co10, n4321_std_scatter_cut, "--", color=cm.brg(2/2.5), alpha=0.5, lw=4, label="NGC 4321 (sensitivity-cut)")
ax1.set_xlim([0,2.2])
ax1.set_ylim([0,0.6])
ax1.legend(ncol=2)
# ax2
