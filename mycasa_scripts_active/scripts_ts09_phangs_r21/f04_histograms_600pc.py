...
for i in range(len(gals)):
	...
	mode =  str(np.round(r21_histo[1][np.argmax(r21_histo[0])],3))
	p84 = str(np.round(r21_histo[1][plot_r21.hist_percent(r21_histo[0],0.843)],3))
	p16 = str(np.round(r21_histo[1][plot_r21.hist_percent(r21_histo[0],0.157)],3))
	print("### no-weight")
	print("# mean = " + mean)
	print("# median = " + median)
	print("# mode = " + mode)
	print("# 84 percentile = " + p84)
	print("# 16 percentile = " + p16)
	# co10-weighted
