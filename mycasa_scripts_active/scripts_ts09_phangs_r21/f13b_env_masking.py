...
plt.rcParams["legend.fontsize"] = 9
#
ax1.scatter(np.log10(co10_mask0_all[0]),np.log10(co21_mask0_all[0]), c=cm.gnuplot(0/3.5), alpha=0.2, linewidths=0)
ax1.scatter(np.log10(co10_mask1_all[0]),np.log10(co21_mask1_all[0]), c=cm.gnuplot(1/3.5), alpha=0.2, linewidths=0)
ax1.scatter(np.log10(co10_mask2_all[0]),np.log10(co21_mask2_all[0]), c=cm.gnuplot(2/3.5), alpha=0.2, linewidths=0)
ax1.scatter(np.log10(co10_mask3_all[0]),np.log10(co21_mask3_all[0]), c=cm.gnuplot(3/3.5), alpha=0.2, linewidths=0)
ax1.set_xlim([-0.0,2.1])
ax1.set_ylim([-0.3,1.8])
#
ax2.scatter(np.log10(co10_mask0_all[1]),np.log10(co21_mask0_all[1]), c=cm.gnuplot(0/3.5), alpha=0.2, linewidths=0)
ax2.scatter(np.log10(co10_mask1_all[1]),np.log10(co21_mask1_all[1]), c=cm.gnuplot(1/3.5), alpha=0.2, linewidths=0)
ax2.scatter(np.log10(co10_mask2_all[1]),np.log10(co21_mask2_all[1]), c=cm.gnuplot(2/3.5), alpha=0.2, linewidths=0)
ax2.scatter(np.log10(co10_mask3_all[1]),np.log10(co21_mask3_all[1]), c=cm.gnuplot(3/3.5), alpha=0.2, linewidths=0)
ax2.set_xlim([-0.0,3.2])
ax2.set_ylim([-0.5,2.7])
#
ax3.scatter(np.log10(co10_mask0_all[2]),np.log10(co21_mask0_all[2]), c=cm.gnuplot(0/3.5), alpha=0.2, linewidths=0)
ax3.scatter(np.log10(co10_mask1_all[2]),np.log10(co21_mask1_all[2]), c=cm.gnuplot(1/3.5), alpha=0.2, linewidths=0)
ax3.scatter(np.log10(co10_mask2_all[2]),np.log10(co21_mask2_all[2]), c=cm.gnuplot(2/3.5), alpha=0.2, linewidths=0)
ax3.scatter(np.log10(co10_mask3_all[2]),np.log10(co21_mask3_all[2]), c=cm.gnuplot(3/3.5), alpha=0.2, linewidths=0)
