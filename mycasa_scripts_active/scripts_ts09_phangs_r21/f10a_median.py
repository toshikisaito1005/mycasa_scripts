...
#for i in [0]:
	...
	bars = ax.plot(list_beam[:-1], norm_median[:-1], "o-", color=color, alpha=0.6, lw=2, label=label1)
	[bar.set_alpha(0.6) for bar in bars]
	#
	norm_median = (np.array(statslist_r21_wco10)[:,2]) / (np.array(statslist_r21_wco10)[:,2][0])
	bars = ax.plot(list_beam[:-1], norm_median[:-1], "o-", color=color, alpha=0.6, lw=2, label=label2)
	[bar.set_alpha(0.4) for bar in bars]
	#
	norm_median = (np.array(statslist_r21_wco21)[:,2]) / (np.array(statslist_r21_wco21)[:,2][0])
	bars = ax.plot(list_beam[:-1], norm_median[:-1], "o-", color=color, alpha=0.6, lw=2, label=label3)
