...
### figure 1
convert -crop 700x570+75+20 $dir_data"ngc0628_12co10_m0.png" $dir_data"ngc0628_12co10_m0b.png"
convert -crop 700x570+75+20 $dir_data"ngc0628_12co21_m0.png" $dir_data"ngc0628_12co21_m0b.png"
convert -crop 700x570+21+20 $dir_data"ngc0628_r21.png" $dir_data"ngc0628_r21b.png"
convert -crop 700x570+75+20 $dir_data"ngc3627_12co10_m0.png" $dir_data"ngc3627_12co10_m0b.png"
convert -crop 700x570+75+20 $dir_data"ngc3627_12co21_m0.png" $dir_data"ngc3627_12co21_m0b.png"
...
convert -append -border 0x0 $dir_data"fig01a.png" $dir_data"fig01b.png" $dir_data"fig01c.png" eps2:$dir_data"f01.eps"
...
### figure 7
convert -crop 1700x1330+70+100 $dir_data"radial_norm_r21.png" $dir_data"radial_norm_r21b.png"
convert -crop 1700x1330+70+100 $dir_data"radial_r21.png" $dir_data"radial_r21b.png"
...
convert -crop 1300x1330+70+100 $dir_data"radial_r21_vs_co21_disp.png" $dir_data"radial_r21_vs_co21_dispb.png"

convert +append -border 0x0 $dir_data"radial_r21_vs_co21_mom0b.png" $dir_data"radial_r21_vs_co21_tpeakb.png" $dir_data"radial_r21_vs_co21_dispb.png" eps2:$dir_data"f08.eps"
