...
for i in range(len(txtfile)):
    ...
    #
    co10_mask0 = co10[np.where((gmcmask==0) & piechartmask==1)]
    co10_mask1 = co10[np.where((gmcmask==1) & piechartmask==1)]
    co10_mask2 = co10[np.where((gmcmask==2) & piechartmask==1)]
    co10_mask3 = co10[np.where((gmcmask>=3) & piechartmask==1)]
    co10_mask0 = co10[np.where((gmcmask==0) & piechartmask==0)]
    co10_mask1 = co10[np.where((gmcmask==1) & piechartmask==0)]
    co10_mask2 = co10[np.where((gmcmask==2) & piechartmask==0)]
    co10_mask3 = co10[np.where((gmcmask>=3) & piechartmask==0)]
    #
