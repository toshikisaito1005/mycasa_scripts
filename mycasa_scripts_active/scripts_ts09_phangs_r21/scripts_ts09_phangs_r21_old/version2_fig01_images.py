...
data_image = glob.glob(dir_data + "*_co/*_4p0*moment0")
data_r21 = glob.glob(dir_data + "*_co/*r21_4p0*image")
data2_image = glob.glob(dir_data + "*_co/*_8p0*moment0")
data2_r21 = glob.glob(dir_data + "*_co/*r21_8p0*image")
data_image = np.r_[data_image, data_r21, data2_image, data2_r21]
...
### Main Procedure
#####################
dir_data = "/Users/saito/data/phangs/co_ratio/ngc0628_co/"
ra_center = "01:36:41.8"
dec_center = "15.47.56.0"
xlim = [-120, 120]
ylim = [120, -120]
value = None
