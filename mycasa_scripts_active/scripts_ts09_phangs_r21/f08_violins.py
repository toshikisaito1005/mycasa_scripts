...
def startup_plot(
	...
	ax1.text(4.2,  0.1,  "4\"", fontsize=10)
	ax1.text(8.2,  0.1,  "8\"", fontsize=10)
	ax1.text(12.2, 0.1, "12\"", fontsize=10)
	ax1.text(16.2, 0.1, "16\"", fontsize=10)
	ax1.text(20.2, 0.1, "20\"", fontsize=10)
	ax2.text(8.2,  0.1,  "8\"", fontsize=10)
	ax2.text(12.2, 0.1, "12\"", fontsize=10)
	ax2.text(16.2, 0.1, "16\"", fontsize=10)
	ax2.text(20.2, 0.1, "20\"", fontsize=10)
	ax2.text(24.2, 0.1, "24\"", fontsize=10)
	ax3.text(4.2,  0.1,  "4\"", fontsize=10)
	ax3.text(8.2,  0.1,  "8\"", fontsize=10)
	ax3.text(12.2, 0.1, "12\"", fontsize=10)
	ax3.text(16.2, 0.1, "16\"", fontsize=10)
	ax3.text(20.2, 0.1, "20\"", fontsize=10)
	ax4.text(1.1, 0.3,  "4\"", fontsize=10)
	ax4.text(2.1, 0.3,  "8\"", fontsize=10)
	ax4.text(3.1, 0.3, "12\"", fontsize=10)
	ax4.text(4.1, 0.3, "16\"", fontsize=10)
	ax4.text(5.1, 0.3, "20\"", fontsize=10)
