...
ia.fromshape(dir_fits + "nyquist_R_13co21_13co10.image",
             [50,50,1,1],
             overwrite = True)
cs=ia.coordsys()
...
exportfits(imagename= dir_fits + 'nyquist_R_13co21_13co10.image',
           fitsimage= dir_fits + 'nyquist_R_13co21_13co10.fits',
           overwrite = True)
ia.close()
