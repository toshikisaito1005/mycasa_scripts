...
for i in range(len(data)):
    ...
    flux = (lumi_hlpha + 0.39e+13 * lumi_vla) / 10. ** 41.27 # sfr
...
ia.fromshape(dir_fits + "nyquist_corr_sfr.image",
             [50,50,1,1],
             overwrite = True)
cs=ia.coordsys()
...
exportfits(imagename= dir_fits + 'nyquist_corr_sfr.image',
           fitsimage= dir_fits + 'nyquist_corr_sfr.fits',
           overwrite = True)
ia.close()
