...
ia.fromshape(dir_fits + "nyquist_R_co21_13co21.image",
             [50,50,1,1],
             overwrite = True)
cs=ia.coordsys()
...
exportfits(imagename= dir_fits + 'nyquist_R_co21_13co21.image',
           fitsimage= dir_fits + 'nyquist_R_co21_13co21.fits',
           overwrite = True)
ia.close()
