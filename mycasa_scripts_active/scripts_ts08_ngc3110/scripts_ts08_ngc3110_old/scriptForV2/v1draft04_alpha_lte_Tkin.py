...
product_data = "photmetry/ngc3110_alpha_lte_Tkin.txt"
...
# main RADEX
d_Tkin_1 = np.loadtxt(dir_data+"photmetry/ngc3110_radex_map_22.0.txt",usecols=(2,3))[:,0]
d_Tkin_2 = np.loadtxt(dir_data+"photmetry/ngc3110_radex_map_22.1.txt",usecols=(2,3))[:,0]
d_Tkin_3 = np.loadtxt(dir_data+"photmetry/ngc3110_radex_map_22.2.txt",usecols=(2,3))[:,0]
d_Tkin_4 = np.loadtxt(dir_data+"photmetry/ngc3110_radex_map_22.3.txt",usecols=(2,3))[:,0]
d_Tkin_5 = np.loadtxt(dir_data+"photmetry/ngc3110_radex_map_22.4.txt",usecols=(2,3))[:,0]
...
f.write("#x y distance alpha_lte err_alpha_lvg\n")
f.close()
...
for i in range(len(fl_13co21)):
    log_Ntot_1, Qrot_1 = myana.rot0_13co(d_Tkin_1[i], fl_13co21[i])
    log_Ntot_2, Qrot_2 = myana.rot0_13co(d_Tkin_2[i], fl_13co21[i])
    log_Ntot_3, Qrot_3 = myana.rot0_13co(d_Tkin_3[i], fl_13co21[i])
    log_Ntot_4, Qrot_4 = myana.rot0_13co(d_Tkin_4[i], fl_13co21[i])
    log_Ntot_5, Qrot_5 = myana.rot0_13co(d_Tkin_5[i], fl_13co21[i])
    ...
    if fl_12co10[i] > 0:
        ...
        # case 4
        NH2_4 = 10 ** log_Ntot_4 / tco_h2
        X_co_4 = NH2_4 / fl_12co10[i]
        alpha_co_4 = 4.3 * X_co_4 / 2e+20
        # case 5
        NH2_5 = 10 ** log_Ntot_5 / tco_h2
        X_co_5 = NH2_5 / fl_12co10[i]
        alpha_co_5 = 4.3 * X_co_5 / 2e+20
    else:
        alpha_co_1 = 0
        alpha_co_2 = 0
        alpha_co_3 = 0
    ...
    mean_alpha_co = (alpha_co_2+alpha_co_3+alpha_co_4) / 3.
    err_alpha_co = max([alpha_co_2,alpha_co_3,alpha_co_4]) \
                   - mean_alpha_co
