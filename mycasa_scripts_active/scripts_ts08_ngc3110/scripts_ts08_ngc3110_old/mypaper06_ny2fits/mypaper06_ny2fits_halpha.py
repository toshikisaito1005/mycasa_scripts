...
ia.fromshape(dir_fits + "nyquist_halpha.image",
             [50,50,1,1],
             overwrite = True)
cs=ia.coordsys()
...
exportfits(imagename= dir_fits + 'nyquist_halpha.image',
           fitsimage= dir_fits + 'nyquist_halpha.fits',
           overwrite = True)
ia.close()
