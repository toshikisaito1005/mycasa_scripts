...
ia.fromshape(dir_fits + "nyquist_b3_contin.image",
             [400,400,1,1],
             overwrite = True)
cs=ia.coordsys()
...
cs.setreferencevalue([qa.convert("151.008708deg", "rad")["value"],
                     ...
                     type = "direction")
cs.setreferencevalue("104.024625GHz", "spectral")
cs.setincrement("1GHz", "spectral")
ia.setcoordsys(cs.torecord())
ia.setbrightnessunit("Jy/pixel")
ia.modify(cl.torecord(),subtract=False)
exportfits(imagename= dir_fits + 'nyquist_b3_contin.image',
           fitsimage= dir_fits + 'nyquist_b3_contin.fits',
           overwrite = True)
ia.close()
