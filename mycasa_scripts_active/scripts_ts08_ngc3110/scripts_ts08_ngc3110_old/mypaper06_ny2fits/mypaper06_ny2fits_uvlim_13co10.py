...
ia.fromshape(dir_fits + "nyquist_13co10_m0_uvlim.image",
             [400,400,1,1],
             overwrite = True)
cs=ia.coordsys()
...
exportfits(imagename= dir_fits + 'nyquist_13co10_m0_uvlim.image',
           fitsimage= dir_fits + 'nyquist_13co10_m0_uvlim.fits',
           overwrite = True)
ia.close()
