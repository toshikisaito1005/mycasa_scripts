...
#
ax1.scatter(np.log10((data2_ci * eqn_fl2lum)[data2_ci > ci_sncut/beamarea*2.5]),
            np.log10((data2_co * eqn_fl2lum_co)[data2_ci > ci_sncut/beamarea*2.5]),
            lw=0,c=r[data2_ci > ci_sncut/beamarea*2.5],cmap="rainbow",alpha=0.5,s=60)
# sensitivity limit
x = np.arange(4.5, 29.0, 0.1)
ax1.fill_between(x, 4.0, co_sncut,
...
ax1.set_ylim([np.log10(data2_co*eqn_fl2lum_co).min()-xwidth1,
...
ax1.set_ylabel("log $L'_{CO(1-0)}$ (K km s$^{-1}$ pc$^2$)")
