...
###eso286
name_csv = dir_work + "eso286_fov.csv"
name_casafile = dir_work + "eso286_fov"
data = []
...
cs.setreferencevalue([qa.convert("314.611096deg","rad")["value"],qa.convert("-42.651586deg","rad")["value"]],type="direction")
