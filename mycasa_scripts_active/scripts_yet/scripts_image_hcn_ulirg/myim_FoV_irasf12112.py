...
###irasf12112
name_csv = dir_work + "irasf12112_fov.csv"
name_casafile = dir_work + "irasf12112_fov"
data = []
...
cs.setreferencevalue([qa.convert("183.441988deg","rad")["value"],qa.convert("2.811525deg","rad")["value"]],type="direction")
