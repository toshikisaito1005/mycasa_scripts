...
###iras13120
name_csv = dir_work + "iras13120_fov.csv"
name_casafile = dir_work + "iras13120_fov"
data = []
...
cs.setreferencevalue([qa.convert("198.776450deg","rad")["value"],qa.convert("-55.156757deg","rad")["value"]],type="direction")
