...
###eso148
name_csv = dir_work + "eso148_fov.csv"
name_casafile = dir_work + "eso148_fov"
data = []
...
cs.setreferencevalue([qa.convert("348.944667deg","rad")["value"],qa.convert("-59.053206deg","rad")["value"]],type="direction")
