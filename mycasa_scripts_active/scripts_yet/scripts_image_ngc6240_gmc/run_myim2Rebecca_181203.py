...
pixelmin = 20 # 5: increment for removing small masks
increment_mask = 8. # 3.0: beam (mask) = beam_size * increment_mask
thres_masking = 3.5 # 2.5: threshold s/n ratio for masking
thres_mom = 0.0 # 1.0: threshold s/n ratio for immoments
pbcut = 0.5 # 0.65: pirmary beam cut
#
dir_data = "/Users/saito/data/ngc6240/gmc_co21/"
galnames = ["ngc6240"]
res_highest = [0.105]
chanss = ["5~169"]
rms_co21_highs = [0.0005]
