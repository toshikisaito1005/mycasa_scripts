...
pixelmin = 10 # 5: increment for removing small masks
increment_mask = 1.5 # 3.0: beam (mask) = beam_size * increment_mask
thres_masking = 2.0 # 2.5: threshold s/n ratio for masking
thres_mom = 0.0 # 1.0: threshold s/n ratio for immoments
pbcut = 0.50 # 0.65: pirmary beam cut
#
dir_data = "/Users/saito/data/vv114_co43/"
galnames = ["vv114_hcn10"]
res_highest = [3.5]
chanss = ["5~33"]
rms_co32_highs = [0.00045]
restfreqs = [88.63160]
