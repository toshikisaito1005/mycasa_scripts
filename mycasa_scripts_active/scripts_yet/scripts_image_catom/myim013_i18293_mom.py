...
galname = "iras18293"
suffix = "p48"
beam_size = 0.48 # target beam size in arcsec
rms_ci10 = 0.0025 # at beam_size
pixelmin = 10 # increment for removing small masks
increment_mask = 2. # beam (mask) = beam_size * increment_mask
thres_masking = 8.0 # threshold s/n ratio for masking
thres_mom = 1.0 # threshold s/n ratio for immoments
chans = "7~37" # channel selection for immoments
pbcut = 0.57 # pirmary beam cut
