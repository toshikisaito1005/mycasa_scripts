...
dir_v3 = "/Users/saito/data/phangs/compare_v3p4_v4/data/"
dir_v4 = "/Users/saito/data/phangs/compare_v3p4_v4/data_pipe_200428/"
...
v3_image    = glob.glob(dir_v3 + "ngc4303_7m_co21_v3.image")[0]
v3_model    = glob.glob(dir_v3 + "ngc4303_7m_co21_v3.model")[0]
v3_pb       = glob.glob(dir_v3 + "ngc4303_7m_co21_v3.pb")[0]
v3_residual = glob.glob(dir_v3 + "ngc4303_7m_co21_v3.residual")[0]
v3_weight   = glob.glob(dir_v3 + "ngc4303_7m_co21_v3.weight")[0]
v3_mask     = glob.glob(dir_v3 + "ngc4303_7m_co21_v3.mask")[0]
...
for i in range(len(v3_products)):
    ...
    output = dir_output + imagename.split("/")[-1]
