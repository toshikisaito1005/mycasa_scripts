...
# plot ax1 scatter
ax1.scatter(lirg_m0[lirg_r<=1.0], lirg_ew[lirg_r<=1.0], c="indianred", s=40, linewidths=0)
...
# plot ax2 right
histo = np.histogram(lirg_ew[lirg_r<=1.0], bins=bins, range=ylim)
...
# plot ax3 bottom
histo = np.histogram(lirg_m0[lirg_r<=1.0], bins=bins, range=xlim)
