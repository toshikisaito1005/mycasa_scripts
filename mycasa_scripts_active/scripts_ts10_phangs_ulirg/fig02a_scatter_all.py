...
#
ax1.plot([-1,5], [-0.74568084691713632,2.2543191530828635], "k--", lw=2)
ax1.plot([-1,5], [-0.59516584908514569,2.4048341509148541], "k--", lw=2)
ax1.plot([-1,5], [-0.24568084691713638,2.7543191530828635], "k--", lw=2)
#
...
ax1.plot([-1,5], [2.7407430300610565,-0.25925696993894354], "k:", lw=2)
#
