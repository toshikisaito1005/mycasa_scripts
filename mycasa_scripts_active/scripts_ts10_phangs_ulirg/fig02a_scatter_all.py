...
#
ax1.plot([-1,5], [-0.74568084691713632,2.2543191530828635], "k--", lw=2) # vir=1
ax1.plot([-1,5], [-0.59516584908514569,2.4048341509148541], "k--", lw=2) # vir=2
ax1.plot([-1,5], [-0.24568084691713638,2.7543191530828635], "k--", lw=2) # vir=10
#
ax1.plot([-1,5], [0.240743030061056,-2.75925696993894376], "k:", lw=2)
ax1.plot([-1,5], [0.7407430300610562,-2.2592569699389438], "k:", lw=2) # Pturb=1e1
ax1.plot([-1,5], [1.240743030061056,-1.75925696993894376], "k:", lw=2)
ax1.plot([-1,5], [1.7407430300610562,-1.2592569699389438], "k:", lw=2) # Pturb=1e3
ax1.plot([-1,5], [2.240743030061056,-0.75925696993894376], "k:", lw=2)
ax1.plot([-1,5], [2.7407430300610565,-0.25925696993894354], "k:", lw=2) # Pturb=1e5
ax1.plot([-1,5], [3.2407430300610565,0.24074303006105646], "k:", lw=2)
ax1.plot([-1,5], [3.7407430300610565,0.74074303006105646], "k:", lw=2) # Pturb=1e7
ax1.plot([-1,5], [4.2407430300610565,1.24074303006105646], "k:", lw=2)
ax1.plot([-1,5], [4.7407430300610565,1.74074303006105646], "k:", lw=2) # Pturb=1e9
ax1.plot([-1,5], [5.2407430300610565,2.24074303006105646], "k:", lw=2)
#
